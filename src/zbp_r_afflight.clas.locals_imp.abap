CLASS LHC_ZR_AFFLIGHT DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
...
CLASS LHC_ZR_AFFLIGHT IMPLEMENTATION.
  ...
  READ ENTITIES OF zr_afflight IN LOCAL MODE
    ENTITY flight
    FIELDS ( Price )
